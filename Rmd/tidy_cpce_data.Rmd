...
cpce <- cpce %>%
  mutate(date = case_when(week == "IA" ~ as.Date("2016-08-20"),     # confirm?
                          week == "PC3" ~ as.Date("2015-07-01"),    # confirm?
...
# SHEET with dates corresponding to each week:
# POM PERM SITE INVENTORY (5 29 18).xlsx
### BW# is different date for different reefs... e.g., BW3 for R2 is novermber, BW3 for R3 is december
