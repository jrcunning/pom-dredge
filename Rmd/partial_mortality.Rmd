...
**We find a significantly higher probability of partial mortality for corals at channelside sites relative to controls for the northern middle reef (77% vs. 4%), the southern middle reef (60% vs. 20%), and the southern outer reef (25% vs. 10%).**
...
### Test differences in tissue loss between channelside and control sites
```{r}
# Fit model
pmor.mod1 <- pmor %>%
...
### Test individual species at the northern middle reef
