...
ggplot(total.depo, aes(x = channel, y = int_fit, fill = channel)) +
  ...
  labs(title = "Total sediment deposition 2014-11-20 to 2015-03-23",
       y = "Grams", x = "")
```
...
ggplot(fine.depo, aes(x = channel, y = int_fit, fill = channel)) +
  ...
  geom_bar(stat = "identity") +
  geom_errorbar(aes(ymin = int_min, ymax = int_max), width = 0.25, lwd = 0.25) +
  labs(title = "Fine sediment deposition 2014-11-20 to 2015-03-23",
       y = "Grams", x = "")
```
...
ggplot(coarse.depo, aes(x = channel, y = int_fit, fill = channel)) +
  ...
  geom_bar(stat = "identity") +
  geom_errorbar(aes(ymin = int_min, ymax = int_max), width = 0.25, lwd = 0.25) +
  labs(title = "Coarse sediment deposition 2014-11-20 to 2015-03-23",
       y = "Grams", x = "")
```
