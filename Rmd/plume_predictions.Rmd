...
png(filename = "figures/Fig10.png", width = 190, height = 95, units = "mm", res = 300)
...
png(filename = "figures/Fig10alt.png", width = 190, height = 95, units = "mm", res = 300)
...
knitr::include_graphics("../figures/Fig10alt.png")
```
