...
**Figure 9. Predicted magnitude and extend of dredging impacts based on dredge plume occurrence.** Lines indicate the mean frequency of dredge plume presence along linear transects from 15km north to 15km south of the channel on the inner, middle, and outer reefs based on satellite imagery and GAM analysis (e.g., Fig. 2). Axes on the right show predicted impacts based on linear transformations of dredge plume presence according to the models in Fig. 8.
