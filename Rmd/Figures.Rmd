...
This is the same as Figure 3 with the time axis extended to show 2016 data points.
...
This is the same as Figure 5 but with the time axis extended to show the 2016 data points.
```{r FigS3}
...
```{r FIGS6, fig.width = 8, fig.height = 4}
