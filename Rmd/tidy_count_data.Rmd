...
##### Reef 2 N:: 2009 transects below 100 m are all same general area as R2N1(-RR)
##### Reef 2 S:: 2009 transects below 100 m are all same general area as R2S1(-RR)
##### Reef 3 N:: 2009 transects below 100 m are all same general area as R3N1(-LR)
##### Reef 3 S:: 2009 transects LR are all same general area as R3S2
all_counts <- all_counts %>%
  mutate(site2 = case_when(
    reef == "R2" & dir == "N" & year == 2009 ~ "RR",
    reef == "R2" & dir == "S" & year == 2009 ~ "RR",
    reef == "R3" & dir == "N" & year == 2009 ~ "LR",
    reef == "R3" & dir == "S" & year == 2009 ~ "LR",
