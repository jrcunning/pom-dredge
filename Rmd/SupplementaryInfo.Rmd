...
**Figure S5. Percent cover before (2013) and after dredging (2016) at the three permanent monitoring sites for which both before and after data were collected.** Sites R2N1 and R2S1 were adjacent to the dredged channel, while site R2SC1 was located ~1.3 km away. Bars indicate the mean percent sediment based on CPCe analysis, and error bars represent standard deviation.
