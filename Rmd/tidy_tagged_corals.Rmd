...
bl_r2 <- bl_r2[, c("Week", "Date", "Site", "Transect", "Coral.ID", "Species", "Condition.Code", "MaxDiam")]
...
bl_r3 <- bl_r3[, c("Week", "Date", "Site", "Transect", "Coral.ID", "Species", "Condition.Code", "MaxDiam")]
...
bl$MaxDiam <- as.numeric(as.character(bl$MaxDiam))
