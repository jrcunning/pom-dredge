...
The paper by Precht et al. reports on a devastating episode of white plague disease that broke out in late 2014 off Miami’s coastline and which, over the following 12 months, spread over a 130 km section of the Florida reef tract. It describes the incidence, etiology, and epidemiology of the disease, and suggests that the disease is “water-borne, infectious, and highly contagious”. 

However, the paper fails to discuss a large-scale dredging operation to widen and deepen the Port of Miami channel that was taking place at the same time, just over 1 km away from the location that Precht et al. report as the epicenter of the disease outbreak. In reporting this outbreak of disease, the authors also fail to include data from the majority of their reef monitoring locations -- and did not include any of their data from the monitoring sites adjacent to the channel being dredged or their monitoring sites on the outer reef or "hardbottom".  In fact, the study only includes 4 of 26 sites where the authors had tagged corals for contemporaneous monitoring. (The dataset also omits certain critical monitoring dates available in the full dataset provided to FDEP). 

In short, we are unable to reproduce many of Precht et al.'s findings, particularly with respect to disease prevalence and mortality. The authors ambiguously define disease prevalence in the Methods section as “...the proportion of cases that were present in the population, at a given time.” However, after follow-up communications with the authors, we now understand that the reported disease prevalence values actually represent a cumulative total of: 1) corals observed with active white plague disease (“WP” condition code), 2) dead corals that were observed with white plague disease some time in the past, and 3) dead corals that were assumed to have died from white plague but were never actually observed with the disease. The latter assumption was made based on a set of criteria that are not clearly described in the Methods[^1], and were not reflected in the data provided to us[^a]. It is also not made clear in the Methods that dead corals are counted in estimates of ongoing "disease prevalence." The description of "disease prevalence" in the Methods section is contradictory, vague, and obfuscated by the Results section that refers to disease prevalence results as, corals “infected with white plague” or “show[ing] outward signs of white plague.”

Our review (detailed below) suggests that the authors’ data omissions and analyses may have fundamentally changed the apparent severity, lethality, location, and timing of the reported disease outbreak.
...
8. [Response to Rachel Silverstein - Part 2 _ RS RC AB Comments_AB.pdf](Response to Rachel Silverstein - Part 2 _ RS RC AB Comments_AB.pdf)
...
### *Scientific Reports* competing interest policy
#####*Highlights indicate where conflicts occur that were not disclosed.*
10. [Appendix I - Competing Interests Policy annotated.pdf](Appendix I - Competing Interests Policy annotated.pdf)

### *\*Updated 2018-09-05:* Precht et al. response to this review (dated: 2018-09-05)
11. [Precht et al. Response to Silverstein et al. 9.7.18 (WFP FINAL).pdf](Precht et al. Response to Silverstein et al. 9.7.18 (WFP FINAL).pdf)

### *\*Updated 2019-05-24:* Cunning et al. 2019 *Mar Poll Bull*: Analysis of dredge impacts at Port of Miami
12. [Cunning et al. 2019 - Extensive coral mortality and critical habitat loss following dredging and their association with remotely-sensed sediment plumes.pdf](Cunning et al. 2019 - Extensive coral mortality and critical habitat los ... g dredging and their association with remotely-sensed sediment plumes.pdf)

### *\*Updated 2019-09-30:* Supplemental reports
13. All Dial Cordy, FDEP, and NMFS reports associated with the dredging project can be accessed [here.](https://github.com/jrcunning/pom-dredge/tree/master/reports)
