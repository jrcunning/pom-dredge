...
In short, we are unable to reproduce many of the reported findings, particularly with respect to reported disease prevalence. The authors define disease prevalence in the methods section as “...the proportion of cases that were present in the population, at a given time”. However, after follow-up communications with the authors, we now understand that the reported disease prevalence values actually include dead corals that were previously observed with white plague disease, and corals that were assumed to have died from white plague despite not having been observed with the disease. The latter assumptions were made based on a set of criteria that are not described in the methods[^1], and were not reflected in the data provided to us[^a]. Therefore, the reported disease prevalence values are not reproducible, are not consistent with the authors' definition of disease prevalence, and do not actually reflect the number of corals “infected with white plague” or “show[ing] outward signs of white plague”. 
...
### Description of species ID conflicts in tagged coral data:
6. [precht_spp_conflicts.txt](precht_spp_conflicts.txt)

### Correspondence with authors to our inquiries about data issues:
...
9. [Addl Comments on Response to Rachel Silverstein - Part 2.pdf](Addl Comments on Response to Rachel Silverstein - Part 2.pdf)

### Data from all middle and outer reef monitoring sites provided to FDEP by authors for compliance monitoring, compiled and reformatted:
