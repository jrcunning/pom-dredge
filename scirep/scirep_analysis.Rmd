...
In short, we are unable to reproduce many of the reported findings, particularly with respect to disease prevalence. The authors define disease prevalence in the Methods section as “...the proportion of cases that were present in the population, at a given time.” However, after follow-up communications with the authors, we now understand that the reported disease prevalence values actually represent a cumulative sum of: 1) corals observed with active white plague disease (“WP” condition code), 2) dead corals that were observed with white plague disease some time in the past, and 3) dead corals that were assumed to have died from white plague but were never actually observed with the disease. The latter assumptions were made based on a set of criteria that are not described in the methods[^1], and were not reflected in the data provided to us[^a]. Therefore, the reported disease prevalence values are not reproducible, are not consistent with the authors’ definition of disease prevalence, and do not actually reflect the number of corals “infected with white plague” or “show[ing] outward signs of white plague” as reported.
